...
namespace LuckyBallSpirit.Controls
{
    ...
    public sealed partial class StatusOptionsPanel : UserControl
    {
        ...
        public void SwitchPanel(StatusCategory category, StatusOptions defaultOption)
        {
            ...
            {
                RedDivPanel.Visibility = Windows.UI.Xaml.Visibility.Visible;
                RedPositionPanel.Visibility = Windows.UI.Xaml.Visibility.Collapsed;
                RedDetailExpendPanel.Visibility = Windows.UI.Xaml.Visibility.Collapsed;
            ...
            {
                RedDivPanel.Visibility = Windows.UI.Xaml.Visibility.Collapsed;
                RedPositionPanel.Visibility = Windows.UI.Xaml.Visibility.Visible;
                RedDetailExpendPanel.Visibility = Windows.UI.Xaml.Visibility.Collapsed;
            ...
            else if (category == StatusCategory.RedGeneral)
            {
                RedDivPanel.Visibility = Windows.UI.Xaml.Visibility.Collapsed;
                RedPositionPanel.Visibility = Windows.UI.Xaml.Visibility.Collapsed;
                RedDetailExpendPanel.Visibility = Windows.UI.Xaml.Visibility.Visible;
