...
namespace LuckyBallSpirit
{
    ...
    sealed partial class App : Application
    {
        ...
        private async void AcquirePushChannel()
        {
            try
            {
                // Get WNS channel for notification.
                CurrentChannel = await PushNotificationChannelManager.CreatePushNotificationChannelForApplicationAsync();

                // Register this channel to cloud and remember the last user login date.
                LuckyBallsData.Util.DataUtil.Login(CurrentChannel.Uri);
            }
            catch
            {
            }
        ...
        void onCommandsRequested(SettingsPane settingsPane, SettingsPaneCommandsRequestedEventArgs eventArgs)
        {
            ...
            SettingsCommand privacyStatement = new SettingsCommand("privacyStatement", "隐私策略", handler);
        ...
        async void onSettingsCommand(IUICommand command)
        {
            ...
            {
                Uri pageUri = new Uri("http://blog.sina.com.cn/s/blog_3ed64e920101k0yn.html");
