...
class CEvenCountTab : public CDialog
{
	DECLARE_DYNAMIC(CEvenCountTab)

public:
	CEvenCountTab(CWnd* pParent = NULL);   // standard constructor
	virtual ~CEvenCountTab();

// Dialog Data
	enum { IDD = IDD_TAB_EVENCOUNT };
